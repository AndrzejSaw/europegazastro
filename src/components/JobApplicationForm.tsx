...
export default function JobApplicationForm() {
  ...
  return (
    <div className="max-w-3xl mx-auto" key="single-job-application-form">
      {/* Header */}
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-center text-xl">Заявка на трудоустройство</CardTitle>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-4">
                <h4 className="text-lg font-medium text-gray-900 border-b pb-2">
                  Документы и дата начала работы
                </h4>
